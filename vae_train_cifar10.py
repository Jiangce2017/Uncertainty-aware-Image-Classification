...
from model_cifar10 import CompoundModel,EABlockFNO
...
if __name__ == '__main__':
    ...
    if uncertainty_model_name == 'eaFNO':
        ...
        uncertainty_model = CompoundModel(device, classifier_name, im_x, im_y, hidden_dim, num_classes, input_channels, modes1, modes2)
